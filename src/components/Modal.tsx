    ...
    return (
        <Dialog.Root open={isOpen} onOpenChange={handleChange}>
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed p-[25px] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] bg-neutral-800 border border-neutral-700 rounded-md focus:outline-none">
